...
func (t *Tim_mucroom) Query(columns ...gdao.Column) ([]Tim_mucroom,error) {
	if columns == nil {
		columns = []gdao.Column{ t.Maxusers,t.Description,t.Createtime,t.Name,t.Domain,t.Password,t.Updatetime,t.Id,t.Roomtid,t.Theme}
	}
...
func NewTim_mucroom(tableName ...string) *Tim_mucroom {
	...
	table := &Tim_mucroom{Createtime:createtime,Name:name,Domain:domain,Password:password,Maxusers:maxusers,Description:description,Id:id,Roomtid:roomtid,Theme:theme,Updatetime:updatetime}
