...
func (t *Tim_offline) Query(columns ...gdao.Column) ([]Tim_offline,error) {
	if columns == nil {
		columns = []gdao.Column{ t.Stanza,t.Id,t.Mid,t.Username,t.Fromuser,t.Msgmode,t.Gname,t.Message_size,t.Createtime,t.Domain,t.Stamp,t.Msgtype}
	}
...
func NewTim_offline(tableName ...string) *Tim_offline {
	...
	table := &Tim_offline{Domain:domain,Stamp:stamp,Msgtype:msgtype_,Message_size:message_size,Stanza:stanza,Id:id,Mid:mid,Username:username,Fromuser:fromuser,Msgmode:msgmode,Gname:gname,Createtime:createtime}
