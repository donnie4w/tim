...
struct_names() ->
  ['TimError', 'TimNode', 'TimAckBean', 'TimHBean', 'TimParam', 'TimTime', 'TimArea', 'Tid', 'TimUserBean', 'TimRoom', 'TimPBean', 'TimMBean', 'TimIqBean', 'TimRoster', 'TimRemoteUserBean', 'TimRemoteRoom', 'TimResponseBean', 'TimSock5Bean', 'TimSock5Bytes', 'TimPage', 'TimMessageIq', 'TimAuth', 'TimMBeanList', 'TimPBeanList', 'TimPropertyBean'].
